...
server.get('/admin/rps', cekLogin, controllers.admin.RPS)
...
server.get('/admin/lecturer/:id', cekLogin, controllers.admin.lecturer)
server.get('/admin/lecturer/add/:id', cekLogin, controllers.admin.hlmTambahAksesDosen)
